    ...
    $scope.SearchProductTransactionList = function () {
        if ($scope.ProductTransferHistorySearchForm.$valid) {
            $http({
                ...
                data: { sellsPointStoreId: $scope.SellsPoint.SellsPointStoreId, shiftId: $scope.SellsPoint.ShiftId, fromDate: $scope.FromDate, toDate: $scope.ToDate }
            }).success(function (data) {
                if (data.success) {
    ...
    $scope.GenerateReportForSearchResult = function () {
        if ($scope.ProductTransferHistorySearchForm.$valid) {
            $http({
                ...
                data: { sellsPointStoreId: $scope.SellsPoint.SellsPointStoreId, shiftId: $scope.SellsPoint.ShiftId, fromDate: $scope.FromDate, toDate: $scope.ToDate, productList: $scope.ProductList, totalAmount: $scope.totalAmount }
            }).success(function (data) {
                if (data.success) {
                    toastr.success(data.successMessage);
                    $scope.ProductList = data.result;
