...
.controller('DatepickerController', ['$scope', '$attrs', '$parse', '$interpolate', '$log', 'dateFilter', 'datepickerConfig', '$datepickerSuppressError', function($scope, $attrs, $parse, $interpolate, $log, dateFilter, datepickerConfig, $datepickerSuppressError) {
  ...
  this.render = function() {
      if (ngModelCtrl.$viewValue) {
          //commited by Asif 26 oct 2015
        //var date = new Date( ngModelCtrl.$viewValue ),
        //  isValid = !isNaN(date);

          //added by Asif 26 oct 2015
        if (angular.isString(ngModelCtrl.$viewValue)) {
            var splitted = ngModelCtrl.$viewValue.split('/');
  ...
  this.isDisabled = function (date) {
      this.minDate= new Date(new Date().getTime() + (1 * 24 * 60 * 60 * 1000));
...
angular.module("template/datepicker/datepicker.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/datepicker/datepicker.html",
    "<div style='margin-top: -33px; list-style= none' ng-switch=\"datepickerMode\" role=\"application\" ng-keydown=\"keydown($event)\">\n" +
