'use strict';
angular.module('myApp', ['ngRoute', 'ui.router', 'smart-table', 'ngAnimate', 'ngInputDate', 'ui.bootstrap', 'ngCart', 'ngFileUpload', 'fancyboxplus', 'blockUI', 'ui.select', 'ngSanitize', 'angular-elevate-zoom', 'ivh.treeview', '720kb.datepicker', 'ui.select', 'ngSanitize'])
